...
INSERT INTO NAV_ITEM VALUES
(
    'M0003', '포인트&보상', '/menu/reward.jpg','모은 포인트를 교환하고 보상을 받습니다.'
);
INSERT INTO NAV_ITEM VALUES
(
...
(
    'U000001', '백병구', '/user/u000001.jpg','남', 52, 0
);
INSERT INTO MEMBER VALUES
(
    'U000002', '문정인', '/user/u000002.jpg','여', 24, 0  
);
INSERT INTO MEMBER VALUES
(
    'U000003', '문성윤', '/user/u000003.jpg','남', 40, 0 
);
INSERT INTO MEMBER VALUES
(
    'U000004', '김동건', '/user/u000004.jpg','남', 26, 0
);
...
(
    'W0001', '프랭크', '/workout/plank.jpg','코어 근육(복근, 허리, 등)을 강화하는 운동으로, 몸을 널빤지처럼 일직선으로 유지하는 동작입니다.', '30초 동안 자세 유지하기'
);
INSERT INTO WORKOUT VALUES
(
    'W0002', '스쿼트', '/workout/squat.jpg','하체 근육(허벅지, 엉덩이)을 강화하는 운동으로, 무릎과 엉덩이를 굽히고 펴는 동작입니다.', '다리를 어깨 너비로 벌리고 앉았다 일어나기'
);
INSERT INTO WORKOUT VALUES
(
    'W0003', '푸시업', '/workout/pushup.jpg','상체 근육(가슴, 어깨, 삼두근)을 강화하는 운동으로, 팔을 굽히고 펴는 동작입니다.', '손은 어깨너비보다 약간 넓게, 손가락은 앞쪽으로 향하게 위치'
);
INSERT INTO WORKOUT VALUES
(
    'W0004', '런지', '/workout/lunge.jpg','하체 근육(허벅지, 엉덩이)을 강화하는 운동으로, 한쪽 다리를 앞으로 내딛고 무릎을 굽히는 동작입니다.', '좌우 각 10회씩 반복하기'
);
